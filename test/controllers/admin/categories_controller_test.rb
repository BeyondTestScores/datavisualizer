...
class Admin::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_new_has_form
    get "/admin/trees/#{trees(:one)}/categories/new", headers: authorized_headers
  ...
  def test_create__only_requires_name
    ...
    post "/admin/trees/#{trees(:one)}/categories", headers: authorized_headers
    assert_select "p", "Invalid Parameters"
    assert_equal category_count, Category.count

    post "/admin/trees/#{trees(:one)}/categories", headers: authorized_headers, params: {
      tree_category: {
        category_attributes: {
          name: ""
        }
    ...
    follow_redirect!
    assert_equal "/admin/trees/#{trees(:one)}/categories/new-category", path
  end

  def test_edit
    tree_category = tree_categories(:two)
    get "/admin/trees/#{trees(:one)}/categories/#{tree_category.category.slug}/edit", headers: authorized_headers
