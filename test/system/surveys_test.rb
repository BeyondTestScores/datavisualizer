...
class SurveysTest < ApplicationSystemTestCase
  ...
  #   new_sq1 = new_survey.school_tree_category_questions.new(
  #     tree_category_question: tree_category_question(:one), 
  #     survey_monkey_id: q1, 
  #     survey_monkey_page_id: q1p
  #   )
  ...
  test "updating a Survey" do
    ...
    visit_admin admin_root_path
    click_on @survey.tree.name, match: :first
