namespace :pilot_parent_test do
  desc "Create data for a Pilot parent test"
  task load: :environment do
    ...
    recipients = [
      # add in recipients here!
      school.recipients.create(name: 'parent1', phone: '555-555-0001'),
      school.recipients.create(name: 'parent2', phone: '5555550002'),
      school.recipients.create(name: 'parent3', phone: '+1 555-555-0003'),
      school.recipients.create(name: 'parent4', phone: '15555550004'),
      school.recipients.create(name: 'parent5', phone: '(555) 555-0005'),
    ]

    recipients[0].students.create(name: 'Andrew')
    recipients[0].students.create(name: 'Charlie')

    recipients[3].students.create(name: 'Zakk')
    recipients[3].students.create(name: 'Camilla')
    recipients[4].students.create(name: 'Zakk')
    recipients[4].students.create(name: 'Camilla')
